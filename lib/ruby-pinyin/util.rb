...
module PinYin
  module Util
    ...
    ASCIIMapping = {
      ...
      'ā' => ['a', 1], 'ē' => ['e', 1], 'ê̄' => ['ei', 1], 'ī' => ['i', 1], 'ō' => ['o', 1], 'ū' => ['u', 1], 'ǖ' => ['v', 1], 'm̄' => ['m', 1], 'n̄' => ['n', 1],
      'á' => ['a', 2], 'é' => ['e', 2], 'ế' => ['ei', 2], 'í' => ['i', 2], 'ó' => ['o', 2], 'ú' => ['u', 2], 'ǘ' => ['v', 2], 'ḿ' => ['m', 2], 'ń' => ['n', 2],
      'ǎ' => ['a', 3], 'ě' => ['e', 3], 'ê̌' => ['ei', 3], 'ǐ' => ['i', 3], 'ǒ' => ['o', 3], 'ǔ' => ['u', 3], 'ǚ' => ['v', 3], 'm̌' => ['m', 3], 'ň' => ['n', 3],
      'à' => ['a', 4], 'è' => ['e', 4], 'ề' => ['ei', 4], 'ì' => ['i', 4], 'ò' => ['o', 4], 'ù' => ['u', 4], 'ǜ' => ['v', 4], 'm̀' => ['m', 4], 'ǹ' => ['n', 4],
      /^lü$/ => ['lv', 5], /^nü$/ => ['nv', 5],
    }
